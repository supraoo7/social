...
class UsersControllerTest < ActionController::TestCase
  ...
  test "should show user" do
    ...
    assert assigns(:user), "cannot fetch @user"
    assert_response :success
  end
  ...
  test "should follow user" do
    ...
    assert user1.following?(user2), "Not following user"
    assert_redirected_to user_url(user2), "Not being redirected to leader page"
  end
